namespace Terraria
{
    ...
    public class Item
    {
        ...
        public void SetDefaults(string ItemName)
        {
            ...
            {
                for (int i = 0; i < 0x1000; i++) //Mod: more items
                {
                    if (i < 0x147 || (i >= Main.minAddedItems && i <= Main.maxAddedItems)) //Mod: added more items
                    {
        ...
        public void SetDefaults(int Type, bool noMatCheck = false)
        {
            ...
            else if (this.type == 0x12f)
            {
                ...
                this.buffType = 0x10;
                this.buffTime = 0x3840;
                this.toolTip = "%15 increase arrow speed and damage";
                this.value = 0x3e8;
                this.rare = 1;
            }
        ...
        public void UpdateItem(int i)
        {
            if (this.active)
            {
                ...
                if (!this.beingGrabbed)
                {
                    ...
                    //Mod
                    if (Collision.PortalCollision(this.position, this.width, this.height, 2, i))
                    {
                    ...
                    if ((((this.owner == Main.myPlayer) && this.lavaWet) && ((this.type != 0x138) && (this.type != 0x13e))) && ((this.type != 0xad) && (this.rare == 0)))
                    {
                        if ((this.type == 0x10b) && (Main.netMode != 1))
                        {
                            for (int m = 0; m < 0x3e8; m++)
                            {
                                if (Main.npc[m].active && (Main.npc[m].type == 0x16))
                                {
                                    ...
                                    Main.npc[m].StrikeNPC(0x270f, 10f, -Main.npc[m].direction);
                                }
                            }
                        }
                        this.active = false;
